...
(function ($) {
	...
	woodmartOptions = (function () {
		...
		var woodmartOptionsAdmin = {
			...
			xtemosElementorProLink: function() {
				$('.elementor-plugins-gopro, .e-overview__go-pro, .elementor-button-go-pro, #toplevel_page_elementor li:last-child a[href="admin.php?page=go_elementor_pro"]').on('click', function(e) {
					e.preventDefault();
		...
		return {
			init: function () {
				$(document).ready(function () {
					...
					woodmartOptionsAdmin.xtemosElementorProLink();
				});
